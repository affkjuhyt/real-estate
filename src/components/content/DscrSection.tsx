          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-2 text-lg/8 text-gray-600">
                {messages['dscr']['a_content']}{" "}
                <span className="font-semibold text-gray-700">
                  {messages['dscr']['b_content']}
                </span>{" "}
                {messages['dscr']['c_content']} <span className="font-semibold text-gray-700">{messages['dscr']['d_content']}</span> {messages['dscr']['e_content']}
              </p>
              <button
