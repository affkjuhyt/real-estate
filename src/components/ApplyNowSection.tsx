...
export default function ApplyNowSection({ messages }: any) {
  return (
    <div className="bg-[#2E3B4E]"> {/* Changed background color to a deep blue */}
      <div className="mx-auto max-w-7xl py-24 sm:py-28 px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-balance text-2xl font-semibold tracking-tight text-white sm:text-3xl uppercase"> {/* Adjusted text color */}
            {messages['home']['contact_us_head']}
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-xl text-gray-300"> {/* Adjusted text color */}
